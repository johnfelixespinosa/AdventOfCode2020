...
# puts "The manifest is #{plane.seat_info}"
# puts "Row #{plane.find_row_with_empty_seat} has an empty seat"
# puts "Column #{plane.find_column_with_empty_seat} has an empty seat"
# puts "Seat at ID #{(plane.find_row_with_empty_seat * 8) + plane.find_column_with_empty_seat} is empty"
